    ...
    if recipe_list:
        ...
        if manage_action == "Edit":
            ...
            if recipe_to_edit:
                ...
                if category_list:
                    category_name = [cat['name'] for cat in category_list]
                    edit_category_name = st.selectbox("Category", category_name, index=category_name.index(
                        next(cat['name'] for cat in category_list
                ...
                if st.button("Update Recipe", key="update_recipe_button"):
                    if all([edit_name, edit_description, edit_ingredients, edit_instructions, edit_cuisine,
                            edit_difficulty, edit_category_id is not None]):
            ...
            if category_list:
                ...
                if manage_action == "Edit":
                    category_to_edit = st.selectbox("Select a category to edit", category_name,
