    ...
    if recipe_list:
        ...
        if manage_action == "Edit":
            ...
            if recipe_to_edit:
                ...
                edit_difficulty = st.selectbox("Difficulty",["Easy", "Medium", "Hard"], inex=["Easy", "Medium", "Hard"].index(selected_recipe['difficulty']), key="edit_recipe_difficulty")
                ...
                if st.button("Update Recipe", key="update_recipe_button"):
                    if all([edit_name,edit_description,edit_ingredients,edit_instructions,edit_cuisine,edit_difficulty, edit_category_id is not None]):
                        update_recipe(selected_recipe['id'], edit_name,edit_description,edit_ingredients,edit_instructions,edit_cuisine,
